...
//
//        return this.numOfClasses;
//        //return 26;  DOI VOI MOT BO DU LIEU CU THE THI SO LUONG LOP HOC CAN GAN LA KHONG DOI
//        // THUAT TOAN CO THE DUNG CHO NHIEU BO DU LIEU KHAC NHAU, VOI SO LUONG LOP CAN XEP LICH KHAC NHAU
//    }
//
//    // calculate number of clashes while making the schedule
//    public int calcClashes() {
//        int clashes = 0;
//        // CHECK RANG BUOC CHO TUNG LOP HOC TRONG SCHEDULE HIEN TAI
